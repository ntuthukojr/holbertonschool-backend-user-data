...
bob@test:~$
bob@test:~$ ./main.py
name=bob;email=bob@test.com;password=xxx;date_of_birth=xxx;
name=bob;email=alice@test.com;password=xxx;date_of_birth=xxx;
bob@test:~$
...
message = "name=bob;email=bob@test.com;ssn=000-123-0000;password=bobby2019;"
...
INSERT INTO users(email) VALUES ("bobtest.com");
INSERT INTO users(email) VALUES ("alice@test.com");

bob@test:~$
bob@test:~$ cat main.sql | mysql -uroot -p
Enter password:
bob@test:~$
bob@test:~$ echo "SELECT COUNT(*) FROM users;" | mysql -uroot -p my_db
Enter password:
2
bob@test:~$
bob@test:~$ cat main.py
...
bob@test:~$
bob@test:~$ PERSONAL_DATA_DB_USERNAME=root PERSONAL_DATA_DB_PASSWORD=root PERSONAL_DATA_DB_HOST=localhost PERSONAL_DATA_DB_NAME=my_db ./main.py
2
bob@test:~$
...
2
bob@test:~$
bob@test:~$ PERSONAL_DATA_DB_USERNAME=root PERSONAL_DATA_DB_PASSWORD=root PERSONAL_DATA_DB_HOST=localhost PERSONAL_DATA_DB_NAME=my_db ./filtered_logger.py
